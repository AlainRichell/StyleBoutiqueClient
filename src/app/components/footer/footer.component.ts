    ...
    <footer class="bg-gray-900 text-white mt-auto">
      <div class="container-custom py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 class="text-lg font-semibold mb-4">Style Boutique</h3>
            <p class="text-gray-400">Su destino de moda único para ropa moderna y asequible.</p>
          </div>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Style Boutique. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  `
